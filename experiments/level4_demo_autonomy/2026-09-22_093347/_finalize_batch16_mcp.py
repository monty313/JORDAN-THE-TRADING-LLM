"""Reconcile L4r cycle 20260922T115429Z from MCP history exits."""
...
ROWS = [
    dict(
        signal_id="20260922T115429Z_EURUSD_3_S3_1",
        symbol="EURUSD",
        direction="SELL",
        ticket=58570160248,
        entry=1.14631,
    ...
    dict(
        signal_id="20260922T115429Z_GBPUSD_3_S3_2",
        symbol="GBPUSD",
        direction="SELL",
        ticket=58570160450,
        entry=1.33623,
    ...
    dict(
        signal_id="20260922T115429Z_USDCAD_3_S3_3",
        symbol="USDCAD",
        direction="BUY",
        ticket=58570160648,
        entry=1.40399,
    ...
    dict(
        signal_id="20260922T115429Z_GBPCHF_2_S2_4",
        symbol="GBPCHF",
        direction="SELL",
        ticket=58570160724,
        entry=1.09485,
    ...
    dict(
        signal_id="20260922T115429Z_EURNZD_1_S3_5",
        symbol="EURNZD",
        direction="BUY",
        ticket=58570160800,
        entry=1.99918,
...
def main() -> int:
    ...
    for r in ROWS:
        ...
        append(
            FORCED,
            {
                ...
                "post_outcome_review": (
                    "Batch16 L4r; MCP blocked; Python MT5; MCP history Expert timed close ~+5m."
                ),
    ...
    append(
        ...
        {
            "ts_utc": now,
            "review": "Level4 batch16 cycle 20260922T115429Z",
    ...
    append(LOG, {"event": "batch16_reconciled", "ts_utc": now, "results": results})
    (EXP / "batch16_results.json").write_text(
        json.dumps({"cycle_id": "20260922T115429Z", "results": results, "reconciled_via": "mcp_history"}, indent=2),
        encoding="utf-8",
    )
    ...
    lines = [
        ...
        "",
        "Account: MetaQuotes-Demo. Our L4r book: **flat**. Foreign Client CADCHF not touched.",
        "",
        "## Batch16 (cycle 20260922T115429Z) comment L4r",
        "MCP blocked. Python MT5. Magic 771249, 0.01.",
        "SL: majors max(80, stops+spread); JPY/CNH max(250, stops+spread). No SEK.",
        "Expert timed close ~+5m (14:59:30–31 broker).",
        "",
