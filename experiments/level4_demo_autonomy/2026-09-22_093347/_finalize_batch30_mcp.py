"""Reconcile L5f cycle 20260922T133948Z from MCP history."""
...
ROWS = [
    dict(
        signal_id="20260922T133948Z_EURUSD_4_S3_1",
        symbol="EURUSD",
        direction="SELL",
        ticket=58572754069,
        entry=1.14556,
    ...
    dict(
        signal_id="20260922T133948Z_USDCAD_1_S3_2",
        symbol="USDCAD",
        direction="BUY",
        ticket=58572754359,
        entry=1.40516,
    ...
    dict(
        signal_id="20260922T133948Z_EURGBP_1_S3_3",
        symbol="EURGBP",
        direction="SELL",
        ticket=58572754550,
        entry=0.85743,
    ...
    dict(
        signal_id="20260922T133948Z_GBPCHF_1_S4_4",
        symbol="GBPCHF",
        direction="BUY",
        ticket=58572754845,
        entry=1.09563,
    ...
    dict(
        signal_id="20260922T133948Z_USDCHF_1_S1_5",
        symbol="USDCHF",
        direction="BUY",
        ticket=58572755017,
        entry=0.82007,
...
def main() -> int:
    ...
    for r in ROWS:
        ...
        append(
            FORCED,
            {
                ...
                "post_outcome_review": (
                    "Batch30 L5f forced five; soft-avoided L5e pairs; MCP blocked; Python MT5."
                ),
    ...
    append(
        ...
        {
            "ts_utc": now,
            "review": "Level4 batch30 cycle 20260922T133948Z L5f forced",
    ...
    append(
        DECISION,
        {"ts_utc": now, "cycle_id": "20260922T133948Z", "event": "batch30_complete", "results": results},
    )
    append(LOG, {"event": "batch30_reconciled", "ts_utc": now, "results": results})
    (EXP / "batch30_results.json").write_text(
        json.dumps({"cycle_id": "20260922T133948Z", "results": results, "reconciled_via": "mcp_history"}, indent=2),
        encoding="utf-8",
    )

    md = ATLAS_MD.read_text(encoding="utf-8")
    if "20260922T133948Z" not in md:
        md += (
            "\n## Review 20260922T134455Z — Level 4 batch30 L5f forced\n\n"
            "Doctrine audit: locked reasons unchanged. Common sense: "
            f"{bits}. Soft-avoided L5e pairs. "
    ...
    lines = [
        ...
        "",
        "Account: MetaQuotes-Demo. Our L5f book: **flat**. Foreign Client CADCHF not touched.",
        "",
        "## Batch30 (cycle 20260922T133948Z) comment L5f",
        "Forced five. Soft-avoided L5e pairs. MCP blocked. Python MT5. Magic 771249, 0.01.",
        "Expert timed close ~+5m (16:44:49–50 broker).",
        "",
