"""Close L4k cycle 20260922T111737Z after hold; score; update handoff. No new opens."""
...
MAGIC = 771249
COMMENT_TAG = "L4k"
HOLD_UNTIL = datetime(2026, 9, 22, 11, 22, 40, tzinfo=timezone.utc)
...
CYCLE = "20260922T111737Z"
SCRIPT = Path(__file__).name

FILLS = [
    {
        "signal_id": "20260922T111737Z_AUDJPY_1_S1_1",
        "symbol": "AUDJPY",
        "direction": "BUY",
        "ticket": 58569492369,
        "entry": 111.781,
    ...
    {
        "signal_id": "20260922T111737Z_USDSEK_3_S1_2",
        "symbol": "USDSEK",
        "direction": "SELL",
        "ticket": 58569492528,
        "entry": 9.8134,
    ...
    {
        "signal_id": "20260922T111737Z_AUDUSD_3_S2_3",
        "symbol": "AUDUSD",
        "direction": "SELL",
        "ticket": 58569492696,
        "entry": 0.71126,
    ...
    {
        "signal_id": "20260922T111737Z_EURGBP_2_S2_4",
        "symbol": "EURGBP",
        "direction": "BUY",
        "ticket": 58569492865,
        "entry": 0.85773,
    ...
    {
        "signal_id": "20260922T111737Z_EURUSD_4_S2_5",
        "symbol": "EURUSD",
        "direction": "SELL",
        "ticket": 58569493072,
        "entry": 1.14613,
...
def main() -> int:
    ...
    log({"event": "batch11_close_done", "ts_utc": utc_now(), "left": left, "our_L4k_left": ours_left})
    ...
    for r in results:
        ...
        append_jsonl(
            FORCED,
            {
                ...
                "post_outcome_review": (
                    "Batch11 L4k; MCP blocked; Python MT5; "
    ...
    append_jsonl(
        ...
        {
            "ts_utc": utc_now(),
            "review": f"Level4 batch11 cycle {CYCLE}",
    ...
    append_jsonl(DECISION, {"ts_utc": utc_now(), "cycle_id": CYCLE, "event": "batch11_complete", "results": results})
    ...
    lines = [
        ...
        "",
        "Account: MetaQuotes-Demo. Our L4k book: **flat**. Foreign Client CADCHF not touched.",
        "",
        f"## Batch11 (cycle {CYCLE}) comment L4k",
        "MCP blocked. Python MT5. Magic 771249, 0.01.",
        "SL: majors max(80, stops+spread); exotics max(250, stops+spread). USDSEK exotic 250.",
        "",
