"""Reconcile L4k cycle 20260922T111737Z from MCP history exits."""
...
def main() -> int:
    ...
    for r in ROWS:
        ...
        append(
            FORCED,
            {
                ...
                "post_outcome_review": (
                    "Batch11 L4k; MCP blocked; Python MT5; MCP history Expert timed close ~+5m."
                ),
    ...
    append(
        ...
        {
            "ts_utc": now,
            "review": "Level4 batch11 cycle 20260922T111737Z",
    ...
    append(LOG, {"event": "batch11_reconciled", "ts_utc": now, "results": results})
    (EXP / "batch11_results.json").write_text(
        json.dumps({"cycle_id": "20260922T111737Z", "results": results, "reconciled_via": "mcp_history"}, indent=2),
        encoding="utf-8",
    )
