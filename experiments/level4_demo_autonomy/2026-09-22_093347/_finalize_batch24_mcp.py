"""Reconcile L4z cycle 20260922T125236Z from MCP history exits."""
...
ROWS = [
    dict(
        signal_id="20260922T125236Z_EURUSD_4_S2_1",
        symbol="EURUSD",
        direction="SELL",
        ticket=58571597490,
        entry=1.14552,
    ...
    dict(
        signal_id="20260922T125236Z_EURGBP_4_S1_2",
        symbol="EURGBP",
        direction="SELL",
        ticket=58571597892,
        entry=0.85778,
    ...
    dict(
        signal_id="20260922T125236Z_USDCAD_1_S2_3",
        symbol="USDCAD",
        direction="BUY",
        ticket=58571598175,
        entry=1.40456,
    ...
    dict(
        signal_id="20260922T125236Z_CHFJPY_1_S1_4",
        symbol="CHFJPY",
        direction="BUY",
        ticket=58571598507,
        entry=191.817,
    ...
    dict(
        signal_id="20260922T125236Z_GBPJPY_1_S1_5",
        symbol="GBPJPY",
        direction="BUY",
        ticket=58571598903,
        entry=210.104,
...
def main() -> int:
    ...
    for r in ROWS:
        ...
        append(
            FORCED,
            {
                ...
                "post_outcome_review": (
                    "Batch24 L4z; MCP blocked; Python MT5; MCP history Expert timed close ~+5m."
                ),
    ...
    append(
        ...
        {
            "ts_utc": now,
            "review": "Level4 batch24 cycle 20260922T125236Z",
    ...
    append(LOG, {"event": "batch24_reconciled", "ts_utc": now, "results": results})
    (EXP / "batch24_results.json").write_text(
        json.dumps({"cycle_id": "20260922T125236Z", "results": results, "reconciled_via": "mcp_history"}, indent=2),
        encoding="utf-8",
    )
    ...
    lines = [
        ...
        "",
        "Account: MetaQuotes-Demo. Our L4z book: **flat**. Foreign Client CADCHF not touched.",
        "",
        "## Batch24 (cycle 20260922T125236Z) comment L4z",
        "MCP blocked. Python MT5. Magic 771249, 0.01.",
        "SL: majors max(80, stops+spread); JPY/CNH max(250, stops+spread). No SEK.",
        "Expert timed close ~+5m (15:57:36–39 broker).",
        "",
    ...
    lines += [
        "",
        "## Next wake",
        "1. Continue until fresh STOP_LEVEL_4_DEMO_AUTONOMY / STOP_FORCED_SIGNAL_LOOP after 08:51 NY.",
