"""Reconcile L4x cycle 20260922T123734Z from MCP history exits."""
...
ROWS = [
    dict(
        signal_id="20260922T123734Z_EURUSD_4_S2_1",
        symbol="EURUSD",
        direction="SELL",
        ticket=58571244568,
        entry=1.14618,
    ...
    dict(
        signal_id="20260922T123734Z_USDCAD_3_S3_2",
        symbol="USDCAD",
        direction="BUY",
        ticket=58571244822,
        entry=1.40457,
    ...
    dict(
        signal_id="20260922T123734Z_EURGBP_4_S1_3",
        symbol="EURGBP",
        direction="SELL",
        ticket=58571245485,
        entry=0.85764,
    ...
    dict(
        signal_id="20260922T123734Z_EURJPY_2_S1_4",
        symbol="EURJPY",
        direction="BUY",
        ticket=58571245769,
        entry=180.171,
    ...
    dict(
        signal_id="20260922T123734Z_EURCAD_1_S2_5",
        symbol="EURCAD",
        direction="BUY",
        ticket=58571245985,
        entry=1.60981,
...
def main() -> int:
    ...
    for r in ROWS:
        ...
        append(
            FORCED,
            {
                ...
                "post_outcome_review": (
                    "Batch22 L4x; MCP blocked; Python MT5; MCP history Expert timed close ~+5m."
                ),
    ...
    append(
        ...
        {
            "ts_utc": now,
            "review": "Level4 batch22 cycle 20260922T123734Z",
    ...
    append(LOG, {"event": "batch22_reconciled", "ts_utc": now, "results": results})
    (EXP / "batch22_results.json").write_text(
        json.dumps({"cycle_id": "20260922T123734Z", "results": results, "reconciled_via": "mcp_history"}, indent=2),
        encoding="utf-8",
    )
    ...
    lines = [
        ...
        "",
        "Account: MetaQuotes-Demo. Our L4x book: **flat**. Foreign Client CADCHF not touched.",
        "",
        "## Batch22 (cycle 20260922T123734Z) comment L4x",
        "MCP blocked. Python MT5. Magic 771249, 0.01.",
        "SL: majors max(80, stops+spread); JPY/CNH max(250, stops+spread). No SEK.",
        "Expert timed close ~+5m (15:42:35–36 broker).",
        "",
    ...
    lines += [
        "",
        "## Next wake",
        "1. Continue until fresh STOP_LEVEL_4_DEMO_AUTONOMY / STOP_FORCED_SIGNAL_LOOP after 08:36 NY.",
