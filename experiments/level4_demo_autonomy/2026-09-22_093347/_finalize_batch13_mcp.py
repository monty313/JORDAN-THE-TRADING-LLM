"""Reconcile L4n cycle 20260922T113336Z from MCP history exits."""
...
ROWS = [
    dict(
        signal_id="20260922T113336Z_AUDUSD_3_S3_1",
        symbol="AUDUSD",
        direction="SELL",
        ticket=58569781373,
        entry=0.71110,
    ...
    dict(
        signal_id="20260922T113336Z_EURGBP_1_S3_2",
        symbol="EURGBP",
        direction="BUY",
        ticket=58569781676,
        entry=0.85811,
    ...
    dict(
        signal_id="20260922T113336Z_USDJPY_3_S4_3",
        symbol="USDJPY",
        direction="SELL",
        ticket=58569781830,
        entry=157.164,
    ...
    dict(
        signal_id="20260922T113336Z_GBPCAD_4_S2_4",
        symbol="GBPCAD",
        direction="BUY",
        ticket=58569782084,
        entry=1.87501,
    ...
    dict(
        signal_id="20260922T113336Z_EURCNH_4_S2_5",
        symbol="EURCNH",
        direction="SELL",
        ticket=58569782155,
        entry=7.67788,
...
def main() -> int:
    ...
    for r in ROWS:
        ...
        append(
            FORCED,
            {
                ...
                "post_outcome_review": (
                    "Batch13 L4n; MCP blocked; Python MT5; MCP history Expert timed close ~+5m."
                ),
    ...
    append(
        ...
        {
            "ts_utc": now,
            "review": "Level4 batch13 cycle 20260922T113336Z",
    ...
    append(LOG, {"event": "batch13_reconciled", "ts_utc": now, "results": results})
    (EXP / "batch13_results.json").write_text(
        json.dumps({"cycle_id": "20260922T113336Z", "results": results, "reconciled_via": "mcp_history"}, indent=2),
        encoding="utf-8",
    )
    ...
    lines = [
        ...
        "",
        "Account: MetaQuotes-Demo. Our L4n book: **flat**. Foreign Client CADCHF not touched.",
        "",
        "## Batch13 (cycle 20260922T113336Z) comment L4n",
        "MCP blocked. Python MT5. Magic 771249, 0.01.",
        "SL: majors max(80, stops+spread); JPY/CNH max(250, stops+spread). No SEK.",
        "Expert timed close ~+5m (14:38:37–39 broker).",
        "",
