"""Reconcile L4u cycle 20260922T121402Z from MCP history exits."""
...
ROWS = [
    dict(
        signal_id="20260922T121402Z_AUDUSD_3_S3_1",
        symbol="AUDUSD",
        direction="SELL",
        ticket=58570560775,
        entry=0.71094,
    ...
    dict(
        signal_id="20260922T121402Z_EURGBP_2_S2_2",
        symbol="EURGBP",
        direction="BUY",
        ticket=58570561053,
        entry=0.85774,
    ...
    dict(
        signal_id="20260922T121402Z_USDCHF_2_S2_3",
        symbol="USDCHF",
        direction="SELL",
        ticket=58570561209,
        entry=0.81944,
    ...
    dict(
        signal_id="20260922T121402Z_EURCHF_2_S2_4",
        symbol="EURCHF",
        direction="SELL",
        ticket=58570561349,
        entry=0.93933,
    ...
    dict(
        signal_id="20260922T121402Z_GBPCHF_2_S2_5",
        symbol="GBPCHF",
        direction="SELL",
        ticket=58570561646,
        entry=1.09511,
...
def main() -> int:
    ...
    for r in ROWS:
        ...
        append(
            FORCED,
            {
                ...
                "post_outcome_review": (
                    "Batch19 L4u; MCP blocked; Python MT5; MCP history Expert timed close ~+5m."
                ),
    ...
    append(
        ...
        {
            "ts_utc": now,
            "review": "Level4 batch19 cycle 20260922T121402Z",
    ...
    append(LOG, {"event": "batch19_reconciled", "ts_utc": now, "results": results})
    (EXP / "batch19_results.json").write_text(
        json.dumps({"cycle_id": "20260922T121402Z", "results": results, "reconciled_via": "mcp_history"}, indent=2),
        encoding="utf-8",
    )
    ...
    lines = [
        ...
        "",
        "Account: MetaQuotes-Demo. Our L4u book: **flat**. Foreign Client CADCHF not touched.",
        "",
        "## Batch19 (cycle 20260922T121402Z) comment L4u",
        "MCP blocked. Python MT5. Magic 771249, 0.01.",
        "SL: majors max(80, stops+spread); JPY/CNH max(250, stops+spread). No SEK.",
        "Expert timed close ~+5m (15:19:02–05 broker).",
        "",
