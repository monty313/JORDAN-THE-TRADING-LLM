"""Reconcile L4y cycle 20260922T124458Z from MCP history exits."""
...
ROWS = [
    dict(
        signal_id="20260922T124458Z_USDCHF_2_S2_1",
        symbol="USDCHF",
        direction="SELL",
        ticket=58571416007,
        entry=0.81963,
    ...
    dict(
        signal_id="20260922T124458Z_EURCHF_2_S2_2",
        symbol="EURCHF",
        direction="SELL",
        ticket=58571416286,
        entry=0.93919,
    ...
    dict(
        signal_id="20260922T124458Z_EURAUD_1_S2_3",
        symbol="EURAUD",
        direction="BUY",
        ticket=58571416605,
        entry=1.61203,
    ...
    dict(
        signal_id="20260922T124458Z_GBPCHF_2_S2_4",
        symbol="GBPCHF",
        direction="SELL",
        ticket=58571416977,
        entry=1.09484,
    ...
    dict(
        signal_id="20260922T124458Z_GBPCAD_1_S2_5",
        symbol="GBPCAD",
        direction="BUY",
        ticket=58571417308,
        entry=1.87589,
...
def main() -> int:
    ...
    for r in ROWS:
        ...
        append(
            FORCED,
            {
                ...
                "post_outcome_review": (
                    "Batch23 L4y; MCP blocked; Python MT5; MCP history Expert timed close ~+5m."
                ),
    ...
    append(
        ...
        {
            "ts_utc": now,
            "review": "Level4 batch23 cycle 20260922T124458Z",
    ...
    append(LOG, {"event": "batch23_reconciled", "ts_utc": now, "results": results})
    (EXP / "batch23_results.json").write_text(
        json.dumps({"cycle_id": "20260922T124458Z", "results": results, "reconciled_via": "mcp_history"}, indent=2),
        encoding="utf-8",
    )
    ...
    lines = [
        ...
        "",
        "Account: MetaQuotes-Demo. Our L4y book: **flat**. Foreign Client CADCHF not touched.",
        "",
        "## Batch23 (cycle 20260922T124458Z) comment L4y",
        "MCP blocked. Python MT5. Magic 771249, 0.01.",
        "SL: majors max(80, stops+spread); JPY/CNH max(250, stops+spread). No SEK.",
        "Expert timed close ~+5m (15:49:58–15:50:01 broker).",
        "",
    ...
    lines += [
        "",
        "## Next wake",
        "1. Continue until fresh STOP_LEVEL_4_DEMO_AUTONOMY / STOP_FORCED_SIGNAL_LOOP after 08:43 NY.",
